...
export async function sendPasswordResetOtp(email: string, otp: string) {
  ...
  const body = emailLayout(
    ...
    <p style="margin:0 0 28px; font-size:15px; color:#4b5563; line-height:1.6;">
      We received a request to reset the password for your KGEC Admin account. Use the code below to proceed.
    </p>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
      <tr>
        <td align="center">
          <div style="display:inline-block; padding:16px 40px; background:linear-gradient(135deg, #1e3a5f 0%, #2d5a8e 100%); border-radius:10px;">
            <span style="font-size:36px; font-weight:800; letter-spacing:8px; color:#ffffff; font-family:'Courier New',Courier,monospace;">
              ${otp}
            </span>
          </div>
        </td>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
      <tr>
        <td style="padding:12px 16px; background-color:#fefce8; border:1px solid #fde68a; border-radius:8px; text-align:center;">
