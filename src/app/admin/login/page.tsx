...
function LoginForm() {
  ...
  return (
    <div className="w-full max-w-md bg-white border border-slate-100 rounded-[2rem] p-8 md:p-10 shadow-2xl relative overflow-hidden z-10">
      ...
      {/* Google OAuth Button */}
      <form action={loginAction} className="relative z-10 w-full">
        <button
          type="submit"
          className="w-full py-4 px-6 rounded-xl bg-white hover:bg-slate-50 text-[#022448] border border-slate-200 font-bold text-sm flex items-center justify-center gap-4 transition-all cursor-pointer shadow-sm hover:shadow-md hover:border-[#225eaa]"
        >
