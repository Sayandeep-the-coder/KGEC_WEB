...
export default function Highlights() {
  return (
    <section className="mx-auto w-full max-w-[100rem] px-4 sm:px-6 lg:px-8 py-4 md:py-6 h-full flex flex-col justify-center overflow-hidden relative touch-pan-y">
      <div className="relative z-10 w-full h-auto lg:h-[88vh] min-h-[600px] rounded-2xl bg-white shadow-md border border-slate-100 flex flex-col p-4 md:p-8 lg:p-10 overflow-hidden">
        ...
        <motion.div 
          ...
          className="flex flex-col items-center justify-center px-5 mb-6 md:mb-8 z-10 text-center shrink-0"
        >
        ...
        {/* Bento Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-3 lg:grid-rows-2 gap-3 md:gap-4 w-full flex-1 min-h-0">
          ...
          <motion.div 
            ...
            className="lg:col-span-2 lg:row-span-2 bg-[#022448] text-white rounded-[2rem] p-6 md:p-8 relative overflow-hidden flex flex-col justify-between min-h-[240px] md:min-h-[320px] shadow-xl group transition-transform hover:-translate-y-2"
          >
            <img 
          ...
          <motion.div 
            ...
            className="lg:col-span-1 bg-[#225eaa] text-white rounded-[2rem] p-6 md:p-8 relative overflow-hidden flex flex-col justify-between min-h-[160px] md:min-h-[180px] shadow-lg group transition-transform hover:-translate-y-2"
          >
          ...
          <motion.div 
            ...
            className="lg:col-span-1 bg-[#d5e3ff] text-[#022448] rounded-[2rem] p-6 md:p-8 relative overflow-hidden flex flex-col justify-between min-h-[160px] md:min-h-[180px] shadow-lg group transition-transform hover:-translate-y-2"
          >
