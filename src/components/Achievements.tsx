...
export default function Achievements() {
  return (
    <section className="mx-auto w-full max-w-[100rem] px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 flex flex-col justify-center relative touch-pan-y">
      {/* Header */}
      <motion.div 
        ...
        className="flex flex-col items-center justify-center px-5 mb-8 md:mb-10 z-10 text-center shrink-0 w-full"
      >
